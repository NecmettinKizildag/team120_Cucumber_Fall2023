...
public class GuruStepdefinitions {
    ...
    public void sutunundaki_tum_degerleri_yazdirir(String istenenBaslik) {
        ...
        List<WebElement> headerElementListesi =guruPage.basikListesi;
        ...
        List<WebElement> istenenSutunElementleriList = Driver.getDriver().findElements(By.xpath(dinamikSutunXpath));
