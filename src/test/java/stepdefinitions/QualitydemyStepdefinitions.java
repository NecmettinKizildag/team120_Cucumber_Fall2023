...
public class QualitydemyStepdefinitions {
    ...
    public void password_kutusuna_yazar(String kullaniciPassword) {
        qualitydemyPage.passwordKutusu.sendKeys(ConfigReader.getProperty(kullaniciPassword));
    }
    ...
    public void passwordKutusunaExamplesDanYazar(String kullaniciPasword) {
        qualitydemyPage.passwordKutusu.sendKeys(kullaniciPasword);
    }
}
